...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20240228093002_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 2, 28, 10, 30, 2, 2, DateTimeKind.Local).AddTicks(2910),
                            DateModified = new DateTime(2024, 2, 28, 10, 30, 2, 2, DateTimeKind.Local).AddTicks(2950),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
