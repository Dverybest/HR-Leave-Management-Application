...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20240309143229_AddMoreAduitFields")]
    partial class AddMoreAduitFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 3, 9, 15, 32, 29, 321, DateTimeKind.Local).AddTicks(9950),
                            DateModified = new DateTime(2024, 3, 9, 15, 32, 29, 322, DateTimeKind.Local),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
